...
local Window = OrionLib:MakeWindow({Name = "Subzero Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Subzero Hub"})
...
W:AddLabel("[+] Subzero Hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Subzero Hub(Noitification)",
